        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">
              <span className="text-orange-500">#3</span> Whiskey
            </div>
          </Link>
          ...
          <div className="flex gap-6 dark:grayscale">
            ...
            <Image
              ...
              height={16}
            />
            <Image src="/assets/icons/x.png" alt="" width={16} height={16} />
          </div>
        </div>
        {/* CENTER */}
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <div className="flex">
            <input
              ...
              className="p-4 w-3/4"
            />
            <button className="w-1/4 bg-paa text-white">JOIN</button>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <Image
              ...
              height={20}
            />
            <Image src="/assets/icons/visa.png" alt="" width={40} height={20} />
          </div>
        </div>
      </div>
      {/* BOTTOM */}
